                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="block">
                                ...
                                <f:form modelAttribute="niveau" action="saveNiveau" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" >
								<!--  
									<div class="form-group">
                                        <label  class="col-md-3 control-label" >ID</label>
                                        <div class="col-md-9">
                                            <f:input  type="hidden" path="niveauID"  class="form-control" />
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Nom Niveau</label>
                                        <div class="col-md-9">
                                            <f:input  path="nomNiveau" class="form-control"/>
                                            <span class="help-block">Nom niveau</span>
                                        </div>
                                    </div>
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <f:textarea  path="descriptionNiveau" class="form-control" />
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-md-offset-4">
                                            <input id = "dateDebut" name = "dateDebut" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" />
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-md-offset-4">
                                            <input id = "dateFin" name = "dateFin" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" />
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        <label class="col-md-3 control-label" for="select_filiere">Filiere</label>
                                        <div class="col-md-9">
                                            <select id="select_filiere" name="select_filiere" class="form-control" size="1" >
                                            	<option value="#"></option><!-- Pour que la première soit vide -->
                                            	<c:forEach  var="pp" items="${filieres}">
                                                <option value="${pp.title}">${pp.title}</option>
                                    ...
                                    <div class="form-group form-actions">
                                        <div class="col-md-9 col-md-offset-3">
											...
											<button type="submit" name="getAll" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Get All Levels </button>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Date fin</th>
		 							 	<th class="text-center">Id filiere</th>
                                        <th style="width: 150px;" class="text-center">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                	<c:forEach  var="p" items="${niveaux}" >
	   	 								<tr>
	      			 						<td>${p.niveauID}</td>
	       									<td>${p.nomNiveau}</td>
	       									<td>${p.descriptionNiveau}</td>
	       									<td>${p.dateDebut}</td>
	       									<td>${p.dateFin}</td>
	       									<td>${p.filiere.f_ID}</td>
	       									<td class="text-center">
                                            	<div class="btn-group btn-group-xs">
                                                	<a href="editNiveau?niveauID=${p.niveauID}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
                                                	<a href="suppNiveau?niveauID=${p.niveauID}" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-times"></i></a>
                                            	</div>
                                        	</td>
