...
<div id="formAdmin" class="cadre">
 ...
 <f:form modelAttribute="professor" action="saveProfessor" method="post" enctype="multipart/form-data">
   <table>
     <tr>
       <td>ID </td>
     ...
     <tr>
      <td>Photo</td>
       ...
       <c:if test="${user.user_id!=null}">
         <img alt="" src="photoProfessor?user_id=${user.user_id}">
       </c:if>
       </td>
       <td>
...
<div id="tabAdmins" class="cadre">
	...
	<c:forEach items="${professors}" var="p">
	    <tr>
	       ...
	       <td><img alt=""src="photoProfessor?userID=${p.user_id}"></td>
	       <td>${p.actived}</td>
	       <td><a href="suppProfessor?userID=${p.user_id}">Supprimer</a></td>
	       <td><a href="editProfessor?userID=${p.user_id}">Editer</a></td>
