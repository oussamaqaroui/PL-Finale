...
<body>
 <!-- Login Full Background -->
        ...
        <img src="<%=request.getContextPath()%>/resources/img/placeholders/backgrounds/login_full_bg.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="block push-bit">
                ...
                <form name="login-form" action="j_spring_security_check" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="gi gi-envelope"></i></span>
                                
                                <input type="text" id="login-email" name="j_username" class="form-control input-lg" placeholder="User Name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="password" id="login-password" name="j_password" class="form-control input-lg" placeholder="Password">
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-actions">
                        ...
                        <input type="submit" name="submit" value="Login" class="btn btn-sm btn-primary" />
                           <i class="fa fa-angle-right"></i> Login to Dashboard</button>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <script src="<%=request.getContextPath()%>/resources/js/pages/login.js"></script>
