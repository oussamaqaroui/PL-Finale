...
<div id="formStud" class="cadre">

 <f:form modelAttribute="stud" action="saveStud" method="post" enctype="multipart/form-data">
   <table>
     <tr>
       <td>ID </td>
     ...
     <tr>
      <td>Photo</td>
       ...
       <c:if test="${user.user_id!=null}">
         <img alt="" src="photoStudent?user_id=${user.user_id}">
       </c:if>
       </td>
       <td>
...
<div id="tabStuds" class="cadre">
	...
	<c:forEach items="${studs}" var="p">
	    <tr>
	       ...
	       <td><img alt=""src="photoStudent?userID=${p.user_id}"></td>
	       <td>${p.actived}</td>
	       <td><a href="suppStudent?userID=${p.user_id}">Supprimer</a></td>
	       <td><a href="editStudent?userID=${p.user_id}">Editer</a></td>
	    </tr>
	</c:forEach>
	</table>
</div>